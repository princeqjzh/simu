									...
									<div class="col-sm-7 infobox-container">
										<div class="infobox infobox-green  ">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">139</span>
												<div class="infobox-content"><!-- 2个评论 -->全部测试执行</div>
											</div>
										...
										<div class="infobox infobox-blue  ">
											...
											<div class="infobox-data">
												...
												<div class="infobox-content">本周新增测试用例</div>
											</div>
										...
										<div class="infobox infobox-pink  ">
											...
											<div class="infobox-data">
												...
												<div class="infobox-content">本周测试执行</div>
											</div>
										...
										<div class="infobox infobox-red  ">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">42</span>
												<div class="infobox-content">全部测试用例数</div>
											</div>
										</div>
										<%-- 
										...
										<div class="infobox infobox-green infobox-small infobox-dark">
											<!-- <div class="infobox-progress">
												<div class="easy-pie-chart percentage" data-percent="31" data-size="39">
													<span class="percent">61</span>%
												</div>
											</div> -->

											<div class="infobox-data">
												<div class="infobox-content">已完成</div>
												<div class="infobox-content">90%</div>
											</div>
										</div>
										...
										<div class="infobox infobox-blue infobox-small infobox-dark">
											...
											<div class="infobox-data">
												<div class="infobox-content">测试通过</div>
												<div class="infobox-content">75%</div>
											</div>
										</div>
										...
										<div class="infobox infobox-grey infobox-small infobox-dark">
											...
											<div class="infobox-data">
												<div class="infobox-content">节约人力</div>
												<div class="infobox-content">40人天</div>
											</div>
										</div>
									</div>
											...
											<div class="widget-header">
												...
												<div class="widget-toolbar no-border">
													<ul class="nav nav-tabs" id="recent-tab">
														<li class="active">
															<a data-toggle="tab" href="#task-tab">执行结果</a>
														</li>

														<li>
															<a data-toggle="tab" href="#member-tab">新增用例</a>
														</li>

														<li>
															<a data-toggle="tab" href="#comment-tab">用户信息</a>
														</li>
													</ul>
												</div>
											</div>
															...
															<ul id="tasks" class="item-list">
																<li class="item-orange clearfix">
																	<label class="inline">
																		...
																		<span class="lbl"> com.onealert.test.regression.ApiAlertInterfaceTest</span>
																	</label>

																	<div class="pull-right easy-pie-chart percentage" data-size="30" data-color="#ECCB71" data-percent="42">
																		通过率：<span class="percent">91</span>%
																	</div>
																</li>
																...
																<li class="item-red clearfix">
																	<label class="inline">
																		<input type="checkbox" class="ace" />
																		<span class="lbl"> com.onealert.test.regression.ZabbixAlertInterfaceTest</span>
																	</label>
																	<div class="pull-right easy-pie-chart percentage" data-size="30" data-color="#ECCB71" data-percent="42">
																		通过率：<span class="percent">85</span>%
																	</div>

																	<!-- <div class="pull-right action-buttons"> //备份修改 删除小button
																		<a href="#" class="blue">
																...
																<li class="item-orange clearfix">
																	<label class="inline">
																		<input type="checkbox" class="ace" />
																		<span class="lbl"> com.onealert.test.regression.NagiosAlertInterfaceTest</span>
																	</label>

																	<div class="pull-right easy-pie-chart percentage" data-size="30" data-color="#ECCB71" data-percent="42">
																		通过率：<span class="percent">90</span>%
																	</div>
																</li>
																<li class="item-orange clearfix">
																	<label class="inline">
																		<input type="checkbox" class="ace" />
																		<span class="lbl"> com.onealert.test.regression.OpenFalconAlertInterfaceTest</span>
																	</label>

																	<div class="pull-right easy-pie-chart percentage" data-size="30" data-color="#ECCB71" data-percent="42">
																		通过率：<span class="percent">78</span>%
																	</div>
																</li>
																<li class="item-orange clearfix">
																	<label class="inline">
																		<input type="checkbox" class="ace" />
																		<span class="lbl"> com.onealert.test.regression.AliyunAlertInterfaceTest</span>
																	</label>

																	<div class="pull-right easy-pie-chart percentage" data-size="30" data-color="#ECCB71" data-percent="42">
																		通过率：<span class="percent">95</span>%
																	</div>
																</li>
													...
													<div class="dialogs">
														...
														<div class="itemdiv dialogdiv">
															...
															<div class="body">
																...
																<div class="text">欢迎大家使用OneAlert自动化测试系统.</div>
